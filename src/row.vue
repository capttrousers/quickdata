<template lang="jade">
  .row(:class="columnData.hierarchy == 'child' ? columnData.hierarchy : ''")
    ...
    tr
      ...
      td
        label  Data type:
        span(v-if="columnData.hierarchy == 'child'" class='childProperty')  {{ columnData.dataType }}
        select(v-else, value="dataType",
      ...
      td
        ...
        label(v-if="columnData.dataType == 'int' || columnData.dataType == 'decimal' ")  Max value:
        label(v-if="columnData.dataType == 'text' ")  Max length:
        span(v-if="columnData.hierarchy == 'child'" class='childProperty')  {{ columnData.maxValue }}
